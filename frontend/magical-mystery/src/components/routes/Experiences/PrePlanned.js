...
import Video from '../../../res/prePlannedVideo.png'

import Icon from '../../../res/prePlannedIcn.png'
    ...
    return (
        <div className="row align-items-start" style={{display: 'flex', flexDirection: 'row', width: "100%", marginLeft: 0, paddingLeft:"10%", paddingRight: "10%", marginBottom:"7%", alignItems:'center', justifyContent: 'center'}}>
            <div style={{flex:1, marginRight: '5%'}}>
                ...
                <br/>
                <h3 style={{display:"block", fontSize:"2rem", clear:"left", float:"left", marginTop:"3%", color:"black"}}>Pre-Planned Experiences</h3>
                <br/>
                ...
                <br/>
                <StartPlanningBtn style={{float:"left", clear:"left", marginTop:"3%", marginRight: '2%'}} to='/preplanned'>Start Planning</StartPlanningBtn>
                <WhiteButton style={{float:"left", marginTop:"3%",}} to='/experiences/preplanned'>See More</WhiteButton>
            </div>
            <div style={{flex:1}}>
