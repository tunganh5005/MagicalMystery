...
const steps = ['Details', 'Destination', 'Activities', 'Restaurants', 'Accommodation', 'Packages', 'Upgrades', 'Checkout']
...
export default () => {
    ...
    return (
        <div style={{paddingTop: '3vw', paddingRight: '10%', paddingLeft: '10%'}}>
            ...
            <Label smallText='Magical Mystery Planning' largeText='Create Your Experience' style={{paddingBottom: '2%'}}/>

            <div style={{color: '#AC623D', fontSize: '1.5vw', marginTop: '2%', marginBottom:'6%'}}>
            
            
            <div style={{position:'relative'}}>
                <hr style={{position: 'absolute', width: '100%', zIndex: -10, marginTop:'2vw', borderTop: 'solid 3px #D5BB9F', marginLeft: '15%'}}/>
                <div class="row align-items-start" style={{paddingLeft: '2%', paddingRight: '2%'}}>
