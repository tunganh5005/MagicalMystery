...
const steps = ['Details', 'Destination', 'Select Your Date', 'Checkout']
...
export default () => {
    ...
    return (
        <div style={{paddingTop: '3vw', paddingRight: '10%', paddingLeft: '10%'}}>
            ...
            <Label smallText='Magical Mystery Planning' largeText='Pre-Planned Unknown Experience' style={{paddingBottom: '2%'}}/>
