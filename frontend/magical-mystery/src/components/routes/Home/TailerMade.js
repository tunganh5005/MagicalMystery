...
import Video from '../../../res/tailerMadeVideo.png'

import Icon from '../../../res/tailerMadeIcn.png'
        ...
        <div className="row align-items-start" style={{display: 'flex', flexDirection: 'row', width: "100%", marginLeft: 0, paddingLeft:"10%", paddingRight: "10%", marginBottom:"7%", alignItems:'center', justifyContent: 'center'}}>
            ...
            <div style={{flex:1}}>
                <div style={{}}>
                    ...
                    <br/>
                    <h3 style={{display:"block", fontSize:"2rem", clear:"left", float:"left", marginTop:"3%", color:"black"}}>Tailor-Made Experience</h3>
                    <br/>
                    ...
                    <br/>
                    <StartPlanningBtn style={{float:"left", clear:"left", marginTop:"3%", marginRight: '2%'}} to='/tailormade'>Start Planning</StartPlanningBtn>
                    <WhiteButton style={{float:"left", marginTop:"3%",}} to='/experiences/tailormade'>See More</WhiteButton>
                </div>
            </div>
        </div>
    )
