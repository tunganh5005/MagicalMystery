...
import Video from '../../../res/puzzledVideo.png'
    ...
    return (
        <div className="row align-items-start" style={{display: 'flex', flexDirection: 'row', width: "100%", marginLeft: 0, paddingLeft:"10%", paddingRight: "10%", marginBottom:"7%", alignItems:'center', justifyContent: 'center'}}>
            <div style={{flex:1, marginRight: '5%'}}>
                ...
                <br/>
                <h3 style={{display:"block", fontSize:"2rem", clear:"left", float:"left", marginTop:"3%", color:"black"}}>Puzzled Experience</h3>
                <br/>
                ...
                <br/>
                <StartPlanningBtn style={{float:"left", clear:"left", marginTop:"3%", marginRight: '2%'}}>Start Planning</StartPlanningBtn>
                <WhiteButton style={{float:"left", marginTop:"3%",}} to='/experiences/puzzled'>See More</WhiteButton>
            </div>
            <div style={{flex:1}}>
